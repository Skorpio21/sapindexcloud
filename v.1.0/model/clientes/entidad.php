   ...
   $boton=$_POST['boton'];
		switch ($boton) {
			...
			case 'registrar':
					...
					$instancia = new Datos();
					if($instancia->registrar($variable_1,$variable_2,$variable_3,$variable_4,$variable_5,$variable_6,$variable_7,$variable_8,$variable_9,$variable_10,$variable_11,$variable_12))
					{
					    echo "exito";
					}
					else{
			...
			case 'modificar':
				...
				$variable_12 = $_POST['variable_12'];
					...
					$instancia = new Datos();
					if($instancia->modificar($variable_1,$variable_2,$variable_3,$variable_4,$variable_5,$variable_6,$variable_7,$variable_8,$variable_9,$variable_10,$variable_11,$variable_12))
					{
					    echo "exito";
					}
					else{
